...
#                 return len(list(filter(lambda ip: ip.is_internet_address(), [packet["IP"].dst_ip, packet["IP"].src_ip]))) == 1
#         return False
#
#     @classmethod
...
#
#     def new_random_port_index(self):
#         """
#         randomizes a port index that does not yet exist
#         :return:
#         """
...
#         :return: None
#         """
#         port_index = self.new_random_port_index()
...
#                 protocol = self.packet_nat_protocol(packet)  # UDP or TCP
#
...
#
#                 else:
#                     raise ThisCodeShouldNotBeReached("A packet always goes either in or out!!!")
