...
class TCPProcess(Process, metaclass=ABCMeta):
    ...
    def _my_tcp_packets(self, packet):
        ...
        if (self.dst_ip is None or self.dst_port is None or self.dst_port is None) and TCP_SYN in tcp_packet.flags:
            return True
