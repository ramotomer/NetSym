...
class PROTOCOLS:
    ...
    class STP:
        ...
        TREE_STABLIZING_MAX_TIME =          30  / STP_RELATIVE_SPEED
        ROOT_MAX_DISAPPEARING_TIME =        40  / STP_RELATIVE_SPEED
        MAX_CONNECTION_DISAPPEARED_TIME =   40  / STP_RELATIVE_SPEED   # in seconds
