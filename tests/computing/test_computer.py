...
#
# def test_domain(self, value: Optional[IPAddress]) -> None:
#     """
#
#     Set the defatest_ult name of the domain (in the /etc/resolv.conf file)
#     """
...
#
#
# def test_raw_sockets(self) -> List[RawSocket]:
#     return [socket for socket in self.sockets if self.sockets[socket].kind == COMPUTER.SOCKETS.TYPES.SOCK_RAW]
#
#
# def test_with_ip(cls: Type[Computer], ip_address: Union[str, IPAddress], name: Optional[str] = None) -> Computer:
#     """
#
#     This is a constructor for a computer with a given IP address, defatest_ults the rest of the properties.
...
#
#
# def test_wireless_with_ip(cls: Type[Computer],
...
#
#
# def test_show(self, x: float, y: float) -> None:
#     """
...
#
#
# def test_print(self, string: str) -> None:
#     """
...
#
#
# def test__print_on_all_shells(self, string: str) -> None:
#     """
...
#
#
# def test__close_all_shells(self) -> None:
#     """
...
#
#
# def test_get_mac(self) -> MACAddress:
...
#
#
# def test_set_name(self, name: str) -> None:
#     """
...
#
#
# def test_start_sniffing(self, interface_name: Optional[str] = INTERFACES.ANY_INTERFACE, is_promisc: bool = False) -> None:
#     """
...
#
#
# def test_stop_all_sniffing(self) -> None:
#     """
...
#
#
# def test_toggle_sniff(self, interface_name: Optional[str] = INTERFACES.ANY_INTERFACE, is_promisc: bool = False) -> None:
#     """
#     Toggles sniffing.
...
#
#
# def test_new_packets_since(self, time_: T_Time, is_raw: bool = False) -> List[ReturnedPacket]:
#     """
...
#
#
# def test_garbage_cleanup(self) -> None:
#     """
...
#
#
# def test_remove_interface(self, name: str) -> None:
#     """
...
#
#
# def test_add_remove_interface(self, name: str) -> None:
#     """
...
#
#
# def test_available_interface(self) -> Interface:
#     """
...
#
#
# def test_disconnect(self, connection: Connection) -> None:
#     """
...
#
#
# def test_same_subnet_interfaces(self, ip_address: IPAddress) -> List[Interface]:
#     """
...
#
#
# def test_interface_by_name(self, name: str) -> Interface:
#     """
...
#
#
# def test_get_ip(self) -> IPAddress:
#     """
...
#
#
# def test_has_this_ip(self, ip_address: Optional[Union[str, IPAddress]]) -> bool:
...
#
#
# def test_get_interface_with_ip(self, ip_address: Optional[IPAddress] = None) -> Interface:
#     """
...
#
#
# def test_is_arp_for_me(self, packet: Packet) -> bool:
...
#
#
# def test_is_for_me(self, packet: Packet) -> bool:
#     """
...
#
#
# def test_is_directly_for_me(self, packet: Packet) -> bool:
#     """
...
#
#
# def test_update_routing_table(self) -> None:
#     """updates the routing table according to the interfaces at the moment"""
#
#     self.routing_table = RoutingTable.create_defatest_ult(self)
#
#
# def test_set_defatest_ult_gateway(self, gateway_ip: IPAddress, interface_ip: Optional[IPAddress] = None) -> None:
#     """
#
#     Sets the defatest_ult gateway of the computer in the routing table with the interface IP that the packets to
#     that gateway will be sent from.
#
#     :param gateway_ip: The `IPAddress` of the defatest_ult gateway.
...
#
#
# def test_set_ip(self, interface: Interface, string_ip: str) -> None:
#     """
...
#
#
# def test_remove_ip(self, interface: Interface) -> None:
#     """
...
#
#
# def test__handle_arp(self, returned_packet: ReturnedPacket) -> None:
#     """
...
#
#
# def test__handle_icmp(self, returned_packet: ReturnedPacket) -> None:
#     """
...
#
#
# def test__handle_tcp(self, returned_packet: ReturnedPacket) -> None:
#     """
...
#
#
# def test__handle_udp(self, returned_packet: ReturnedPacket) -> None:
#     """
...
#
#
# def test__handle_special_packet(self, returned_packet: ReturnedPacket) -> None:
#     """
...
#
#
# def test__send_fragment_ttl_exceeded(self, dst_mac: MACAddress, dst_ip: IPAddress) -> None:
#     """
...
#
#
# def test__pop_fragments(self, fragments: Iterable[Packet]) -> None:
#     """
...
#
#
# def test__handle_ip_fragments(self, returned_packet: ReturnedPacket) -> Optional[ReturnedPacket]:
#     """
...
#
#
# def test__forget_old_ip_fragments(self) -> None:
#     """
...
#
#
# def test_set_dns_server_for_dhcp_server(self, dns_server: IPAddress) -> None:
#     """
...
#
#
# def test_set_domain_for_dhcp_server(self, domain: T_Hostname) -> None:
#     """
#     Assumes that the computer is a DHCP server
#
#     Sets the defatest_ult name of the domain that the DHCPServerProcess give new clients
#     """
...
#
#     return self.dns_cache[self.add_defatest_ult_domain_prefix_if_necessary(name)].ip_address
#
#
# def test_add_dns_entry(self, user_inserted_dns_entry_format: str) -> None:
#     """
...
#
#
# def test_add_remove_dns_zone(self, zone_name: T_Hostname) -> None:
#     """
...
#
#
# def test_add_defatest_ult_domain_prefix_if_necessary(self, name_to_resolve: T_Hostname) -> T_Hostname:
#     """
#
#     If the name to resolve was `Hello` and the defatest_ult domain of the computer was `tomer.noyman.`
...
#
#
# def test_send(self, packet: Packet, interface: Optional[Interface] = None, sending_socket: Optional[RawSocket] = None) -> None:
#     """
...
#
#
# def test_send_with_ethernet(self, dst_mac: MACAddress, dst_ip: IPAddress, data: Union[str, bytes, scapy.packet.Packet]) -> None:
#     """
...
#
#
# def test_send_to(self, dst_mac: MACAddress, dst_ip: IPAddress, packet: Packet, **kwargs: Any) -> None:
#     """
...
#
#
# def test_ip_wrap(self, dst_mac: MACAddress, dst_ip: IPAddress, protocol: scapy.packet.Packet, ttl: Optional[int] = None, **kwargs: Any) -> Packet:
#     """
...
#
#
# def test_udp_wrap(self, dst_mac: MACAddress, dst_ip: IPAddress, src_port: T_Port, dst_port: T_Port, protocol: scapy.packet.Packet) -> Packet:
#     """
...
#
#
# def test_start_sending_udp_packet(self, dst_ip: IPAddress, src_port: T_Port, dst_port: T_Port, data: Union[str, bytes, scapy.packet.Packet]) -> None:
#     """
...
#
#
# def test_send_arp_to(self, ip_address: IPAddress) -> None:
#     """
...
#
#
# def test_send_arp_reply(self, request: Packet) -> None:
#     """
...
#
#
# def test_arp_grat(self, interface: Interface) -> None:
#     """
...
#
#
# def test_send_time_exceeded(self, dst_mac: MACAddress, dst_ip: IPAddress, data: Union[str, bytes] = '') -> None:
#     """
...
#
#
# def test_validate_dhcp_given_ip(self, ip_address: IPAddress) -> bool:
#     """
...
#
#
# def test__handle_packet_streams(self) -> None:
#     """
...
#
#
# def test__cleanup_unused_packet_sending_queues(self) -> None:
#     """
...
#
#
# def test_get_packet_sending_queue(self, pid: int, mode: str) -> PacketSendingQueue:
#     """
...
#
#
# def test_get_udp_socket(self, requesting_process_pid: int) -> UDPSocket:
#     """
...
#
#
# def test_get_tcp_socket(self, requesting_process_pid: int) -> TCPSocket:
#     """
...
#
#
# def test_get_raw_socket(self, requesting_process_pid: int) -> RawSocket:
#     """
...
#
#
# def test__is_port_taken(self, port: T_Port, kind: int = COMPUTER.SOCKETS.TYPES.SOCK_STREAM) -> bool:
#     """
#     Returns whether or not a port is already bound to a socket.
#     """
#
#
#     def test_is_registered_on_port(socket_data: SocketData) -> bool:
...
#
#
# def test_get_open_ports(self, protocol: Optional[str] = None) -> List[int]:
#     """
...
#
#
# def test_bind_socket(self, socket: Socket, address: Tuple[IPAddress, T_Port]) -> None:
#     """
...
#
#
# def test_remove_socket(self, socket: Socket) -> None:
#     """
...
#
#
# def test__remove_all_sockets(self) -> None:
#     """
...
#
#
# def test__sniff_packet_on_relevant_raw_sockets(self, returned_packet: ReturnedPacket, sending_socket: Optional[RawSocket] = None) -> None:
#     """
...
#
#
# def test__sniff_packet_on_relevant_udp_sockets(self, packet: Packet) -> None:
#     """
...
#
#
# def test_open_port(self, port_number: int, protocol: str = "TCP") -> None:
#     """
...
#
#
# def test__does_packet_match_socket_fourtuple(self, socket: Socket, packet: Packet) -> bool:
#     """
...
#
#
# def test__does_packet_match_udp_socket_fourtuple(self, socket: Socket, packet: Packet) -> bool:
#     """
...
#
#
# def test__does_packet_match_tcp_socket_fourtuple(self, socket: Socket, packet: Packet) -> bool:
#     """
...
#
#
# def test__cleanup_unused_sockets(self) -> None:
#     """
...
#
#
# def test_select(socket_list: List[Socket], timeout: Optional[Union[int, float]] = None) -> Generator[WaitingFor, None, Optional[Socket]]:
#     """
...
#
#
# def test__interfaces_from_dict(cls, dict_: Dict) -> List[Interface]:
#     """
...
#
#
# def test_from_dict_load(cls, dict_: Dict) -> Computer:
#     """
